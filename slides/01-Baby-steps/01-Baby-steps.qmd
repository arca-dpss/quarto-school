...
## YAML: `T`able `o`f `C`ontents (ToC) {footer="false"}
...
3. Define the fontsize (other options are avilable)
...
I removed the icon from this specific callout. If you want to remove the icons from **all** the blocks, go in the YAML: 
