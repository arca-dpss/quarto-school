...
## `echo`: Control the code display {.smaller}
...
Overruled by spefici code-chunk options:
...
1. Basic table, the `kable()` function is the `knitr` package
...
* Add a table based on the dataset, with a caption and a crossreference
